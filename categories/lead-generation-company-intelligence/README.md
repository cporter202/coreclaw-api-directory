...
**11 APIs** across **7 data sources**

## Sources

[Amazon](#amazon) · [Google Maps](#google-maps) · [Indeed](#indeed) · [LinkedIn](#linkedin) · [Made-in-China](#made-in-china) · [SEO & Marketing](#seo-marketing) · [YouTube](#youtube)
...
<a id="seo-marketing"></a>
## SEO & Marketing (1)

| API | Worker ID | What it does |
|---|---|---|
| [**Domain Email Finder**](https://www.coreclaw.com/odin-kael/domain-email-finder?fpr=chris69) | `odin-kael/domain-email-finder` | Find public email addresses for a website or domain. Domain Email Finder is a Coreclaw Python Worker that crawls a target website, checks common contact-related pages, queries selected free public sources, and outputs deduplicated email findings with source attribution, classification, confidence, |
